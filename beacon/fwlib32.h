...
typedef struct out_statinfo_dmg {
     short  dummy[1];     /* ���g�p                       */
     short  dmg;          /* DMG Netservice�X�e�[�^�X��� */
     short  dummy1[7];    /* ���g�p                       */
} OUT_STATINF_DMG ;
...
typedef struct tagODBIFSBFSSBUNT {
    short   slv_unt_num;    /* �X���[�u���j�b�g�ԍ� */
    short   fssb_unt_num;   /* FSSB���j�b�g�ԍ� */
    char    name[4];        /* ���� */
} ODBIFSBFSSBUNT;
...
typedef struct tagODBIFSBCOMSTATDTL {
    long    error_inf;      /* �G���[��� */
    long    jitter_inf;     /* �W�b�^��� */
    char    n_warning;      /* �m�C�Y���[�j���O�t���O */
    char    j_warning;      /* �W�b�^���[�j���O�t���O */
    char    reserve[2];     /* ���U�[�u */
} ODBIFSBCOMSTATDTL;

typedef struct tagODBIFSBWARNINGMSG {
    short   line;     /* ���[�j���O�������C���ԍ� */
    short   slv_src;  /* ���[�j���O�����X���[�u�ԍ�(�ʐM��) */
    short   slv_dst;  /* ���[�j���O�����X���[�u�ԍ�(�ʐM��) */
    short   type;     /* �������[�j���O�^�C�v */
    char    wm_typ[32]; /* ���[�j���O���b�Z�[�W(ܰ�ݸގ��) */
    char    wm_pnt[32]; /* ���[�j���O���b�Z�[�W(ܰ�ݸމӏ�) */
} ODBIFSBWARNINGMSG;
...
typedef struct tagODBIFSBWARNHSTMSG {
    ...
    char    second;     /*                   �b */
    char    dummy;
    ODBIFSBWARNINGMSG   msg_dat;    /*$ ���b�Z�[�W $*/
} ODBIFSBWARNHSTMSG;
