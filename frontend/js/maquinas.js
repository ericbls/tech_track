...
function updateList(){
	$.ajax({
		...
		resp.forEach(function(item, index){
			...
			table_html += "<th> <button type=\"button\" class=\"btn btn-danger\"><i data-eva=\"github\" data-eva-fill=\"#ffffff\" data-eva-height=\"24\" data-eva-width=\"24\" data-eva-animation=\"flip\"></i></button> </th>"
			table_html += "</tr>"
		})
